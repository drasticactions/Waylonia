...
internal sealed class DesktopShellPolicy(IAvaloniaShellPolicy inner, IHostCursor cursor) : IAvaloniaShellPolicy
{
    private readonly IAvaloniaShellPolicy _inner = inner;
    private readonly IHostCursor _cursor = cursor;
    ...
    public void PlaceWindow(Window window, ToplevelInfo info)
    {
        ...
        var screen = _cursor.TryGetPixelPoint() is { } cursor
