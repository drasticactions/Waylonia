...
internal sealed class LinuxXWayland : IXWaylandHost
{
    public IProtocolModule? TryCreateModule() => new XWaylandModule();
    ...
    public string? DisplayName(BasinCompositorHost host) =>
