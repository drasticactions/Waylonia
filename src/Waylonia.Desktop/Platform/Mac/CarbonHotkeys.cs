...
internal sealed unsafe class CarbonHotkeys : IDisposable
{
    ...
    private static CarbonHotkeys? _active;
    ...
    private CarbonHotkeys(Action<Hotkey> launch) => _launch = launch;

    public static CarbonHotkeys? TryStart(IReadOnlyList<Hotkey> hotkeys, Action<Hotkey> launch)
    {
        var instance = new CarbonHotkeys(launch);
