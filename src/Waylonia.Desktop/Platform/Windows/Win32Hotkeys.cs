...
internal sealed class Win32Hotkeys : IDisposable
{
    ...
    private Win32Hotkeys(TopLevel anchor, IntPtr handle, Action<Hotkey> launch)
    {
        _anchor = anchor;
        _handle = handle;
        _launch = launch;
    ...
    public static Win32Hotkeys? TryStart(
        IReadOnlyList<Hotkey> hotkeys, TopLevel anchor, Action<Hotkey> launch)
    {
        ...
        var instance = new Win32Hotkeys(anchor, handle.Handle, launch);
        var next = 1;
