...
public sealed class WayloniaCommand
{
    ...
    public WayloniaCommand(string description)
    {
        ...
        _logLevel = Add(CliOptions.LogLevel());
        _allocReport = Add(CliOptions.AllocReport());
    }
    ...
    public void ConfigureLogging(ParseResult result, bool trace = false)
    {
        ...
        BasinLog.Level = CliOptions.ParseLogLevel(name);
