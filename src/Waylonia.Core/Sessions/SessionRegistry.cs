...
internal sealed class SessionRegistry(ISessionHost host)
{
    ...
    public static bool ExitsProcess(bool adHoc, bool commandFinished, bool hadClients, bool othersLive, bool manager) =>
        adHoc && (commandFinished || !hadClients) && !othersLive && !manager;
