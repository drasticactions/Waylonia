...
public sealed class WorkspacesTests
{
    ...
    internal void No_wrap_stops_at_the_edge_of_a_single_row(int current, WorkspaceDirection direction, int? expected)
    {
    ...
    internal void Wrap_styles_follow_marco_on_a_two_by_two_grid(int current, WorkspaceDirection direction, WrapStyle wrap, int? expected)
    {
    ...
    [InlineData(0, WorkspaceDirection.Up, WrapStyle.Classic, 3)]
    internal void Wrap_styles_on_a_single_row(int current, WorkspaceDirection direction, WrapStyle wrap, int? expected)
    {
    ...
    internal void An_uneven_grid_never_lands_on_a_missing_cell(int current, WorkspaceDirection direction, WrapStyle wrap, int? expected)
    {
