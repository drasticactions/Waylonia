...
public sealed class FocusPolicyTests
{
    ...
    internal void A_window_takes_focus_when_nothing_is_focused(FocusNewWindows mode)
    {
    ...
    [InlineData(FocusNewWindows.Smart)]
    [InlineData(FocusNewWindows.Strict)]
    internal void A_transient_of_the_focused_window_always_takes_focus(FocusNewWindows mode)
    {
    ...
    internal void Focus_follows_the_pointer_under_sloppy_and_mouse(FocusMode mode, bool expected)
    {
    ...
    [InlineData(FocusMode.Mouse, true)]
    internal void Only_mouse_focus_drops_focus_when_the_pointer_leaves_to_the_desktop(FocusMode mode, bool expected)
    {
