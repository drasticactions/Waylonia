...
public sealed class SessionRegistryTests
{
    ...
    public void An_ad_hoc_session_ends_the_process_when_its_command_finished_or_no_client_came_and_nothing_else_runs(
        bool adHoc, bool commandFinished, bool hadClients, bool othersLive, bool manager, bool exits)
    {
        Assert.Equal(exits, SessionRegistry.ExitsProcess(adHoc, commandFinished, hadClients, othersLive, manager));
    }
